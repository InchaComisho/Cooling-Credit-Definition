...
![تعريف أرصدة التبريد](images/Cooling-Credit-Definition-AR.png)
...
للاطلاع على الحدود التفصيلية بين التبريد، والتظليل الشمسي، والظل، والانعكاس، والألبيدو، وخفض إدخال الحرارة، راجع [تعريف حدود تسمية التبريد](docs/COOLING_NAMING_BOUNDARY_ar.md).
...
- [تعريف حدود تسمية التبريد](docs/COOLING_NAMING_BOUNDARY_ar.md) — الحدود الصارمة بين التبريد والتظليل والانعكاس والألبيدو وخفض إدخال الحرارة.
- [نموذج إعادة تشغيل التغذية الراجعة للتبريد الطبيعي](docs/NATURAL_COOLING_FEEDBACK_RESTART_ar.md) — نموذج لإعادة تشغيل التغذية الراجعة الذاتية للتبريد عبر الماء والتربة والغطاء النباتي والمحيطات والدوران.
